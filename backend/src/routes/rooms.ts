...
router.post(
  '/',
  requireRole(['ADMIN']),
  validateWithZod(createRoomSchema, 'body'),
...
//Get room by ID
router.get('/:id', validateWithZod(validateParamID, 'params'), roomController.getRoomByID);
...
router.patch(
  ...
  validateWithZod(updateRoomSchema, 'body'),
